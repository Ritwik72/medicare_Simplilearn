...
if(window.history.forward(1)! =null)
	window.histry.forward(1);</script>
</head>
<body>
<br>
<table>
...
%>
      ...
      ResultSet rs2=st.executeQuery("select *from user where enail='"+email+"'");
...
<hr style="width: 100%">
<from action="addressPaymentForOrderAction.jsp"method="post">
 <div class="left-div">
 <h3>Enter Address</h3>
...
<div class="right-div">
<h3>Pay online on this ritwik@pay.com</h3>
...
<div class="left-div">
<h3>Mobile Number</h3>
<input class="input-style" type="bigint" name="mobileNumber" value="<%=rs2.getString(3)%>"placeholder="Enter Mobile Number" required>
